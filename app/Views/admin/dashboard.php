...
<div class="card bg-gradient-danger card-img-holder text-white">
    ...
    <h4 class="font-weight-normal mb-3">Jumlah Skripsi <i class="mdi mdi-chart-line mdi-24px float-end"></i>
    </h4>
...
<div class="card bg-gradient-info card-img-holder text-white">
    <div class="card-body">
    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
    <h4 class="font-weight-normal mb-3">Jumlah Mahasiswa<i class="mdi mdi-bookmark-outline mdi-24px float-end"></i>
    </h4>
